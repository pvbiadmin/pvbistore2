                            ...
                            <form action="{{ route('admin.withdraw-method.update', $method->id) }}" method="POST">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control decimal-input"
                                                   ...
                                                   value="{{ old('minimum_amount') ?? $method->minimum_amount }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control decimal-input"
                                                   ...
                                                   value="{{ old('maximum_amount') ?? $method->maximum_amount }}">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" step="0.01" class="form-control decimal-input"
                                                   ...
                                                   value="{{ old('withdraw_charge') ?? $method->withdraw_charge }}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea id="description" name="description"
                                              class="summernote">{!! old('description')
