...
@section( 'title' )
    {{ $settings->site_name }} || Paymaya Payment
@endsection
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <ul>
                            ...
                            <li><a href="javascript:">paymaya payment</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-xl-6 col-md-10 col-lg-8 col-xxl-5 m-auto">
                        <div class="wsus__404_text">
                            <h2>Thanks!</h2>
                            <h4>Please settle your <span>Paymaya</span><br> Payment using the following details:</h4>
                            <hr>
                            <h5><span>Account Name:</span> {{ $paymayaSettings->name }}</h5>
                            <h5><span>GCash Number:</span> {{ $paymayaSettings->number }}</h5>
