                        ...
                        @foreach ( $vendors as $vendor )
                            <div class="col-xl-6 col-md-6">
                                <div class="wsus__vendor_single">
                                    <img src="{{ $vendor->banner && file_exists(public_path($vendor->banner))
                                        ? asset($vendor->banner) : 'https://picsum.photos/590/414' }}"
                                         alt="vendor" class="img-fluid w-100">
                                    <div class="wsus__vendor_text">
                                        <div class="wsus__vendor_text_center">
                                            <h4>{{ $vendor->shop_name }}</h4>
                                            <a href="javascript:">
                                                <i class="far fa-phone-alt"></i>{{ $vendor->phone }}</a>
                                            <a href="javascript:">
                                                <i class="fal fa-envelope"></i>{{ $vendor->email }}</a>
