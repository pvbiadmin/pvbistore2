...
class UnilevelSettingDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function ($query) {
                $view_btn = '<a href="' . route('admin.unilevel.edit', $query->id) .
                    '" class="btn btn-primary"><i class="far fa-edit"></i></a>';
                $delete_btn = '<a href="' . route('admin.unilevel.destroy', $query->id) .
     ...
     */
    public function query(UnilevelSetting $model): QueryBuilder
    {
    ...
    {
        return $this->builder()
                    ->setTableId('unilevelsetting-table')
