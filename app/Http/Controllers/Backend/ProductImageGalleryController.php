...
class ProductImageGalleryController extends Controller
{
     ...
     * @param \App\DataTables\ProductImageGalleryDataTable $dataTable
     * @return mixed
     */
    public function index(Request $request, ProductImageGalleryDataTable $dataTable): mixed
    {
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->back()->with(['message' => 'Product Image Uploaded Successfully']);
    }
