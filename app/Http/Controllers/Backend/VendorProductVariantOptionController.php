...
use App\DataTables\VendorProductVariantOptionDataTable;
...
class VendorProductVariantOptionController extends Controller
{
    /**
     * @param \App\DataTables\VendorProductVariantOptionDataTable $dataTable
     * @param $product_id
     * @param $variant_id
     * @return mixed
     */
    public function index(VendorProductVariantOptionDataTable $dataTable, $product_id, $variant_id): mixed
    {
        $product = Product::query()->findOrFail($product_id);
        $variant = ProductVariant::query()->findOrFail($variant_id);

        return $dataTable->render('vendor.product.product-variant-option.index',
    ...
    public function create(string $product_id, string $variant_id): View|Application|Factory|\Illuminate\Contracts\Foundation\Application
    {
        ...
        return view('vendor.product.product-variant-option.create',
            compact('product', 'variant'));
    }
    ...
    public function store(Request $request): RedirectResponse
    {
        ...
        return redirect()->route('vendor.products-variant-option.index',
...
//        $product = Product::query()->findOrFail($variant->product_id);
        ...
        return view('vendor.product.product-variant-option.edit', compact(
    ...
    public function update(Request $request, string $id): RedirectResponse
    {
        ...
        return redirect()->route('vendor.products-variant-option.index',
            ...
            ->with(['message' => 'Vendor Product Variant Option Updated Successfully']);
    }
